...
<qgis version="1.9.90-Alpha" minimumScale="0" maximumScale="26000" hasScaleBasedVisibilityFlag="1">
    ...
    <symbols>
      ...
      <symbol outputUnit="MM" alpha="1" type="marker" name="@0@0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="name" v="E:/data/Kadaster/images/ewegnummer.svg"/>
          <prop k="offset" v="0,0"/>
  ...
  <label>1</label>
  <labelfield>EWEGNUMMER</labelfield>
  <labelattributes>
    <label fieldname="EWEGNUMMER" text=""/>

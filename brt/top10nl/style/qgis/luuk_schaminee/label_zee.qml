...
<qgis version="1.9.90-Alpha" minimumScale="0" maximumScale="26000" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <singlesymbol>
    <symbol>
      ...
      <outlinewidth>0.16</outlinewidth>
      <fillcolor red="176" blue="199" green="186"/>
  ...
  <labelattributes>
    <label fieldname="NAAM" text="Label"/>
    ...
    <color fieldname="" red="0" blue="230" green="92"/>
    <x fieldname=""/>
    <y fieldname=""/>
  ...
  <edittypes>
    <edittype type="0" name="AANTALINWO"/>
    ...
    <edittype type="0" name="TYPEGEOGRA"/>
    <edittype type="0" name="TYPEGEOGRG"/>

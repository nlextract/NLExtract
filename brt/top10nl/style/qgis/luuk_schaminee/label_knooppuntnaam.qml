...
<qgis version="1.9.90-Alpha" minimumScale="0" maximumScale="26000" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <singlesymbol>
    <symbol>
      ...
      <outlinecolor red="186" blue="237" green="244"/>
  ...
  <label>1</label>
  <labelfield>KNOOPPUNTN</labelfield>
  <labelattributes>
    <label fieldname="KNOOPPUNTN" text=""/>
    ...
    <color fieldname="" red="0" blue="168" green="77"/>
    <x fieldname=""/>
    <y fieldname=""/>
    <offset x="0" y="0" units="pt" yfieldname="" xfieldname=""/>
    <angle fieldname="" value="0" auto="0"/>
    <alignment fieldname="" value="center"/>
    <buffercolor fieldname="" red="85" blue="255" green="255"/>
  ...
  <edittypes>
    ...
    <edittype type="0" name="HOOFDVER_1"/>
    ...
    <edittype type="0" name="TYPEWEG_C1"/>
    <edittype type="0" name="VERHARDING"/>
    <edittype type="0" name="VERHARDI_1"/>
    <edittype type="0" name="VERHARDI_2"/>
    <edittype type="0" name="VERHARDI_3"/>

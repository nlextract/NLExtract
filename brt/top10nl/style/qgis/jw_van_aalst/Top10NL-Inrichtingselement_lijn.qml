...
<qgis version="1.7.3-Wroclaw" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="typeinrichtingselement" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="1" value="bomenrij" label="bomenrij"/>
      <category symbol="2" value="dam, koedam" label="dam, koedam"/>
      <category symbol="3" value="geluidswering" label="geluidswering"/>
      <category symbol="4" value="heg, haag" label="heg, haag"/>
      <category symbol="5" value="hekwerk" label="hekwerk"/>
      <category symbol="6" value="hoogspanningsleiding" label="hoogspanningsleiding"/>
      <category symbol="7" value="muur" label="muur"/>
      <category symbol="8" value="schietbaan" label="schietbaan"/>
      <category symbol="9" value="sluisdeur" label="sluisdeur"/>
      <category symbol="10" value="stuw" label="stuw"/>
      <category symbol="11" value="verkeersgeleider" label="verkeersgeleider"/>
      <category symbol="12" value="wegafsluiting" label="wegafsluiting"/>
      <category symbol="13" value="kabelbaan" label="kabelbaan"/>
    ...
    <symbols>
      ...
      <symbol outputUnit="MM" alpha="1" type="line" name="15">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="183,78,197,255"/>
          <prop k="customdash" v="1.5;0.71"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0"/>

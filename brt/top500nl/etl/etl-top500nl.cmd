...
:: (etl-top500nl-v1.2.1.cfg) en parameters (options\myoptions.args) aan te roepen. Dit script is
...
:: Evt via commandline overrulen: etl-top500nl.cmd <mijn optiebestand>

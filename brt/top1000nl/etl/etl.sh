...
# (etl-top1000nl-v1.2.0.cfg) en parameters (options/myoptions.args) aan te roepen.
#
...
# Evt via commandline overrulen: etl-top1000nl.sh <my options file>
[ -f "$1" ] && options_file=$1

# Uiteindelijke commando. Kan ook gewoon "stetl -c conf/etl-top1000nl-v1.2.0.cfg -a ..." worden indien Stetl installed
# python $STETL_HOME/stetl/main.py -c conf/etl-top1000nl-v1.2.0.cfg -a "$pg_options temp_dir=temp max_features=$max_features gml_files=$gml_files $multi $spatial_extent"

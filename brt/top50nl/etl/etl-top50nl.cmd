...
:: (etl-top50nl-v1.1.cfg) en parameters (options\myoptions.args) aan te roepen. Dit script is
...
python %STETL_HOME%\stetl\main.py -c conf\etl-top50nl-v1.1.cfg -a %options_file%

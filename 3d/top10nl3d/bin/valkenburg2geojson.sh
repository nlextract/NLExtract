...
/bin/rm -rf ${TOP10NL_3D_HOME}/geojson > /dev/null
...
do
   ...
   # Naar GeoJSON in RD
   ogr2ogr  -t_srs "EPSG:28992"  -f "GeoJSON" ${TOP10NL_3D_HOME}/geojson/rd/valkenburg-${LAAG}-rd.json ${TOP10NL_3D_HOME}/Valkenburg.gdb -sql "SELECT * FROM ${LAAG}"

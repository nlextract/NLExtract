...
<qgis version="1.9.90-Alpha" minimumScale="0" maximumScale="500000" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0">
  <transparencyLevelInt>255</transparencyLevelInt>
  <classificationattribute>TYPERELIEF</classificationattribute>
  <uniquevalue>
    <classificationfield>TYPERELIEF</classificationfield>
    <symbol>
      <lowervalue>1</lowervalue>
      <uppervalue>1</uppervalue>
      <label>dieptelijn</label>
      ...
      <outlinecolor red="0" blue="168" green="77"/>
    ...
    <symbol>
      ...
      <scaleclassificationfieldname></scaleclassificationfieldname>
      <symbolfieldname></symbolfieldname>
      <outlinecolor red="168" blue="0" green="56"/>
      <outlinestyle>DashLine</outlinestyle>
      <outlinewidth>0.26</outlinewidth>
      <fillcolor red="0" blue="0" green="0"/>
      <fillpattern>NoBrush</fillpattern>
    ...
    <symbol>
      <lowervalue>6</lowervalue>
      <uppervalue>6</uppervalue>
      <label>laagwaterlijn</label>
      <pointsymbol>hard:circle</pointsymbol>
      <pointsize>2</pointsize>
      <pointsizeunits>pixels</pointsizeunits>
      <rotationclassificationfieldname></rotationclassificationfieldname>

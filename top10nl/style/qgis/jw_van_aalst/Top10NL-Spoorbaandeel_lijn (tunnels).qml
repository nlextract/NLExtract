...
<qgis version="1.7.3-Wroclaw" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol outputUnit="MM" alpha="0.6" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="87,87,90,255"/>
  ...
  <edittypes>
    <edittype type="0" name="BEHEERDER"/>
    <edittype type="0" name="BRON"/>
    <edittype type="0" name="GEOCODE"/>
    <edittype type="0" name="HOEKVERHOU"/>
    <edittype type="0" name="ID"/>
    <edittype type="0" name="KM_NAAR"/>
    <edittype type="0" name="KM_VAN"/>
    <edittype type="0" name="LENGTE"/>
    <edittype type="0" name="LENGTE_BER"/>
    <edittype type="0" name="NAAR"/>
    <edittype type="0" name="NAAR_ID"/>
    <edittype type="0" name="NAAR_ID2"/>
    <edittype type="0" name="NR"/>
    <edittype type="0" name="NR2"/>
    <edittype type="0" name="OBEGINTIJD"/>
    <edittype type="0" name="OBJECTCODE"/>
    <edittype type="0" name="TYPE"/>
    <edittype type="0" name="VAN"/>
    <edittype type="0" name="VAN_ID"/>
    <edittype type="0" name="VAN_ID2"/>
    <edittype type="0" name="WISSELNR_N"/>
    <edittype type="0" name="WISSELNR_V"/>
    <edittype type="0" name="WISSEL_KRU"/>
    <edittype type="0" name="X_NAAR"/>
    <edittype type="0" name="X_VAN"/>
    <edittype type="0" name="Y_NAAR"/>
    <edittype type="0" name="Y_VAN"/>
    <edittype type="0" name="aantalspor"/>
    <edittype type="0" name="aantalsporen"/>
    ...
    <edittype type="0" name="elektrificatie"/>
    ...
    <edittype type="0" name="spoorbreedte"/>
    <edittype type="0" name="status"/>
    <edittype type="0" name="typeinfras"/>
    <edittype type="0" name="typeinfrastructuurspoorbaandeel"/>
    <edittype type="0" name="typespoorb"/>
    <edittype type="0" name="typespoorbaan"/>

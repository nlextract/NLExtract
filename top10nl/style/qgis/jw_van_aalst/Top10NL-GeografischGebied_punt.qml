...
<qgis version="1.7.3-Wroclaw" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol outputUnit="MM" alpha="0.4941176470588236" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="198,141,172,255"/>
  ...
  <labelattributes>
    <label fieldname="naam" text="(onbekend)"/>
    ...
    <color fieldname="" red="35" blue="205" green="72"/>
    <x fieldname=""/>
    <y fieldname=""/>
  ...
  <edittypes>
    ...
    <edittype type="0" name="typeGeografischGebied"/>

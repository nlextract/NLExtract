...
<qgis version="1.7.3-Wroclaw" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="typegebouw" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="(1:brandtoren)" label="(1:brandtoren)"/>
      <category symbol="1" value="(1:kas, warenhuis)" label="(1:kas, warenhuis)"/>
      <category symbol="2" value="(1:klokkentoren)" label="(1:klokkentoren)"/>
      <category symbol="3" value="(1:koeltoren)" label="(1:koeltoren)"/>
      <category symbol="4" value="(1:lichttoren)" label="(1:lichttoren)"/>
      <category symbol="5" value="(1:luchtwachttoren)" label="(1:luchtwachttoren)"/>
      <category symbol="6" value="(1:radartoren)" label="(1:radartoren)"/>
      <category symbol="7" value="(1:radiotoren, televisietoren)" label="(1:radiotoren, televisietoren)"/>
      <category symbol="8" value="(1:telecommunicatietoren)" label="(1:telecommunicatietoren)"/>
      <category symbol="9" value="(1:toren)" label="(1:toren)"/>
      <category symbol="10" value="(1:uitzichttoren)" label="(1:uitzichttoren)"/>
      <category symbol="11" value="(1:verkeerstoren)" label="(1:verkeerstoren)"/>
      <category symbol="12" value="(1:vuurtoren)" label="(1:vuurtoren)"/>
      <category symbol="13" value="(1:watertoren)" label="(1:watertoren)"/>
      <category symbol="14" value="(1:zendtoren)" label="(1:zendtoren)"/>
      <category symbol="15" value="(2:kasteel,toren)" label="(2:kasteel,toren)"/>
      <category symbol="16" value="(2:kerk,toren)" label="(2:kerk,toren)"/>
      <category symbol="17" value="(2:klokkentoren,religieus gebouw)" label="(2:klokkentoren,religieus gebouw)"/>
      <category symbol="18" value="(2:klokkentoren,toren)" label="(2:klokkentoren,toren)"/>
      <category symbol="19" value="(2:museum,watertoren)" label="(2:museum,watertoren)"/>
      <category symbol="20" value="(2:religieus gebouw,toren)" label="(2:religieus gebouw,toren)"/>
    ...
    <symbols>
      ...
      <symbol outputUnit="MM" alpha="1" type="fill" name="10">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="color" v="152,206,252,255"/>
          <prop k="color_border" v="18,17,55,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="style" v="solid"/>
          <prop k="style_border" v="solid"/>
      ...
      <symbol outputUnit="MM" alpha="1" type="fill" name="13">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="color" v="40,98,166,255"/>
          <prop k="color_border" v="14,17,40,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="style" v="solid"/>
          <prop k="style_border" v="solid"/>
          <prop k="width_border" v="0.24"/>
      ...
      <symbol outputUnit="MM" alpha="1" type="fill" name="14">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="color" v="18,245,33,255"/>
          <prop k="color_border" v="16,44,14,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="style" v="solid"/>
          <prop k="style_border" v="solid"/>
          <prop k="width_border" v="0.21"/>
      ...
      <symbol outputUnit="MM" alpha="1" type="fill" name="5">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="color" v="113,156,199,255"/>
          <prop k="color_border" v="15,17,45,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="style" v="solid"/>
          <prop k="style_border" v="solid"/>
          <prop k="width_border" v="0.24"/>
      ...
      <symbol outputUnit="MM" alpha="1" type="fill" name="6">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="color" v="78,219,62,255"/>
          <prop k="color_border" v="17,44,14,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="style" v="solid"/>
          <prop k="style_border" v="solid"/>
          <prop k="width_border" v="0.22"/>

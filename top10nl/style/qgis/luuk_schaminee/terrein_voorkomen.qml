...
<qgis version="1.9.90-Alpha" minimumScale="0" maximumScale="100000" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0">
  <transparencyLevelInt>255</transparencyLevelInt>
  <classificationattribute>VOORKOMEN_</classificationattribute>
  <uniquevalue>
    <classificationfield>VOORKOMEN_</classificationfield>
    <symbol>
      <lowervalue>1</lowervalue>
      <uppervalue>1</uppervalue>
      <label>dras, moerassig</label>
      ...
      <outlinecolor red="110" blue="110" green="110"/>
      <outlinestyle>SolidLine</outlinestyle>
      <outlinewidth>0.26</outlinewidth>
      <fillcolor red="0" blue="230" green="169"/>
      <fillpattern>TexturePattern</fillpattern>
      <texturepath>./images/dras-moerassig.png</texturepath>
    </symbol>
    <symbol>
      ...
      <fillpattern>TexturePattern</fillpattern>
      <texturepath>./images/riet.png</texturepath>
    </symbol>
    <symbol>
      <lowervalue>3</lowervalue>
      <uppervalue>3</uppervalue>
      <label>dras, moerassig en riet</label>
      <pointsymbol>hard:circle</pointsymbol>
      <pointsize>2</pointsize>
      <pointsizeunits>pixels</pointsizeunits>
      <rotationclassificationfieldname></rotationclassificationfieldname>
      ...
      <fillcolor red="0" blue="230" green="169"/>
      <fillpattern>TexturePattern</fillpattern>
      <texturepath>./images/dras-moerassig-riet.png</texturepath>
    </symbol>
  </uniquevalue>
  <customproperties/>

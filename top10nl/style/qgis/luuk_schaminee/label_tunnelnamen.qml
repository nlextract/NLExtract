...
<qgis version="1.9.90-Alpha" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="26000" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="1">
  ...
  <singlesymbol>
    <symbol>
      ...
      <outlinecolor red="207" blue="123" green="150"/>
  ...
  <label>1</label>
  <labelfield>TUNNELNAAM</labelfield>
  <labelattributes>
    <label fieldname="TUNNELNAAM" text=""/>
    <family fieldname="" name="Arial"/>
    <size fieldname="" units="pt" value="36"/>
    <bold fieldname="" on="0"/>

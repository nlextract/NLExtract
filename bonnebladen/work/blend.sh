...
function mask_source_file() {
  # e.g. map_num is b091-1932, resultaat in ${map_num}m.png
  map_num=$1
...
# Leg het naburige kaartblad over target, bijv westkant van blad b092 is overlayed met b091
# De transparante kleuren in de randen worden geblend via 'Multiply'
# Via "geometry" verschuift de overlap zodat precies de overlappende randen samenvallen
...
# maak composite uit masked bron blad met omringende N,O,Z,W bladen
...
# eenmalig maskfile aanmaken
create_maskfile

# maak voor alle bronbladen een masked versie met transparante randen
...
# maak voor ieder blad composite met omringende N,O,Z,W bladen
